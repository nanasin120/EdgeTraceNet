...
from loss.loss import color_difference_loss, regularization_loss
...
def train():
    ...
    for epoch in range(START_EPOCH, END_EPOCH + 1):
        ...
        scheduler.step()
        print(f'==> Epoch {epoch} 완료 Train Loss : {avg_train_loss:.4f} Color Loss : {avg_train_color_loss:4f} Regular Loss : {avg_train_regular_loss:4f} Time : {epoch_end_time-epoch_start_time:.4f}')
